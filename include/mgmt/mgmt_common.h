...
#define MSG_GET_RSC_CONST       "get_rsc_constraints"
#define MSG_GET_FILE_CONTEXT        "get_file_context"
#define MSG_SAVE_FILE_CONTEXT        "save_file_context"
#define MSG_STATUS_HBLINKS        "status_hblinks"
#define MSG_SYSTEM        "system"
#define MSG_GET_CORO_CONFIG    "get_coro_config"
#define MSG_GET_LOCALNODE	"get_local_node"
#define MSG_PWD_DECODE		"pwd_decode"
#define MSG_PWD_ENCODE		"pwd_encode"
#define MSG_GET_TOTEM		"get_totem"
#define MSG_GET_SQLDATA		"get_sqldata"
#define MSG_UPDATE_SQLDATA	"update_sqldata"
#define MSG_SSH_NODE		"ssh_node"
/*neoshineha ming.liu add end*/
#define MSG_LIC_VERID   "lic_verid"
#define MSG_LIC_EXPIRE "lic_expire"
